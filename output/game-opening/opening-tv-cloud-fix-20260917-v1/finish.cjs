...
m.changes=['CRT physical glass boundary corrected to x1520..1790/y598..758, fixed rounded mask and edge-scanline overscan','Single monotonic camera, no programme scale reset at fullscreen handoff','Sky plate drift: 286.90 output pixels over 12.4 seconds, including entire telephone interval; no wrap seams'];
m.integration='TV fit and cloud-motion correction, authorized 2026-09-17; previous approved export preserved';
